    ...
    return (
        <Fragment>
            {page === "accountNavbar" ? (
                        ...
                        >
                            ...
                            <li>
                                <Link href={`/account/${accountID}/watchlist`}>
                                    <a
                                        className={`${classes["account_subpage_link--EL"]
                                            } ${classes["playlistLink"]} ${params === "watchlist"
                                                ? classes["activeLink"]
                                                : ""
                                            }`}
                                    >
                            ...
                            <li>
                                <Link href={`/account/${accountID}/movies`}>
                                    <a
                                        className={`${classes["account_subpage_link--EL"]
                                            } ${classes["moviesLink"]} ${params === "movies"
                                                ? classes["activeLink"]
                                                : ""
                                            }`}
                                    >
                            ...
                            <li>
                                <Link href={`/account/${accountID}/tvShows`}>
                                    <a
                                        className={`${classes["account_subpage_link--EL"]
                                            } ${classes["tvShowsLink"]} ${params === "tvShows"
                                                ? classes["activeLink"]
                                                : ""
                                            }`}
                                    >
                            ...
                            <li>
                                <Link href={`/account/${accountID}/actors`}>
                                    <a
                                        className={`${classes["account_subpage_link--EL"]
                                            } ${classes["usersLink"]} ${params === "actors"
                                                ? classes["activeLink"]
                                                : ""
                                            }`}
                                    >
                ...
                <header
                        className={`f-center-between ${classes["mainNavbar--EL"]} ${!!page && classes["signupPage_navbar--EL"]
                            }`}
                    >
                        <span
                        ...
                        <Link href='javascript:void(0)' >
                            <a
                                onClick={(e) =>
                                    changeModalStateHandler(e, "logIn", true)
                                }
                            >
                                log in
                            </a>
